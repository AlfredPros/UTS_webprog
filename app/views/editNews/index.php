...
<div class="container" style="padding-top: 4%" data-aos="fade">
    <div class="row text-center" style="margin-bottom: 28px;">
        <h1 style="color:#c90000">Edit News</h1>
    </div>
    <div class="row justify-content-center">
        <form method="POST" action="<?= base_url ?>doeditnews" class="col-md-6" enctype="multipart/form-data">
            ...
            <div class="form-group" style="padding-bottom:15px">
                ...
                <input type="text" class="form-control" id="newsTitle" name="newsTitle" placeholder="News Title" value="<?= $data['nid'][1] ?>" required>
            </div>
            <div class="form-group" style="padding-bottom:15px">
            ...
            <div class="form-group" style="padding-bottom:15px">
                ...
                <div class="custom-file">
                    <input type="file" class="form-control" id="newsThumbnail" name="newsThumbnail" placeholder="News Thumbnail" value="<?= $data['nid'][3] ?>" required>
                </div>
            </div>
            <div class="form-group" style="padding-bottom:15px">
