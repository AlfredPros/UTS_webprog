<div class="container" style="padding-top: 25px; padding-bottom: 25px">
    ...
    <div class="row" data-aos="fade-down">
        <div class="col-md-12">
            ...
            <div class="row">
                <a href="<?= base_url . $data['allnews'][0][2] ?>" style="font-size: medium; padding-bottom:8px; text-decoration: none; color: #C90000;"><?= $data['allnews'][0][2] ?></a>
            </div>
        </div>
    </div>
    ...
    ?>
        <div class="col-md-4" data-aos="fade-up" data-aos-offset="60">
            ...
            <div class="row">
            <a href="<?= base_url . $news[2] ?>" style="font-size: small; padding-bottom:8px; text-decoration: none; color: #C90000;"><?= $news[2] ?></a>
            </div>
        </div>
    <?php 
        } }
